...
break;
case 2:
 this.$ = {type: 'select', columns: $$[$0-6], from: $$[$0-4], where:$$[$0-3], group:$$[$0-2], having:$$[$0-1], order:$$[$0]}; 
break;
...
break;
case 105: case 106:
 this.$ = {type: 'FunctionCall', name: $$[$0-3], args: $$[$0-1]}; 
break;
case 107:
 this.$ = {type:'Case', clauses: $$[$0-2], else: $$[$0-1]}; 
break;
case 108:
 this.$ = $$[$0-4]; $$[$0-4].push({type: 'CaseItem', when: $$[$0-2], then: $$[$0]}); 
break;
case 109:
 this.$ = [{type: 'CaseItem', when: $$[$0-2], then: $$[$0]}]; 
break;
}
},
